...
class CrossModalDetailSelector(nn.Module):
    ...
    All inputs are projected to a small channel width first:
        RGB semantic
        TIR semantic
        |RGB-TIR|
    ...
    def __init__(
        ...
        # r, t, |r-t|, detail, sr, st -> 6*g; plus targetness -> 1.
        ...
        # selector multiplier starts exactly at 1.
