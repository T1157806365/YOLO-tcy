...
python visualize_rlsfa_bhlr_v2_internal.py \
  --weights runs/rlsfa_bhlr_v2/yolo26n_UAVCB_RLSFA-P3_BHLRv2-P3_v2_rgb1280_sem640_tir640_seed0_v4/weights/best.pt \
  --split test \
  --device 5 \
...
def visualize_one(
    ...
    #
    # Actual forward order after removing D3 from the selector decision:
    #   [r,t,|r-t|,sr,st,A]
    ...
    save_native(
        ...
        (
            "head[0] output from [r,t,|r-t|,sr,st,A] (D3 excluded); "
            "1x1 Conv-BN-SiLU; "
    ...
    save_native(
        ...
        (
            ...
            "assigned separately to r/t/|r-t|/sr/st; D3 is not an input"
        ),
    )
    ...
    metadata = {
        ...
        "export_policy": {
            ...
            "d3_selector_policy": "D3 excluded from Z3/M3 decision; retained only in D_use=M3*D3",
            "bhlr_selector_order": [
        ...
        "bhlr_v2": {
            ...
            "selector_decision": {
                "inputs": ["r", "t", "abs_r_minus_t", "sr", "st", "targetness"],
                "d3_in_z3_decision": False,
                "input_channels_when_guide_channels_24": 121,
            ...
            "senet": {
                ...
                "input_feature": "24-channel fused selector feature from [r,t,|r-t|,sr,st,targetness]",
