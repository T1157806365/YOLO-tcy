...
python visualize_rlsfa_bhlr_v2_internal.py \
  --weights runs/rlsfa_bhlr_v2/yolo26n_UAVCB_RLSFA-P3_BHLRv2-P3_v2_rgb1280_sem640_tir640_seed0_v5/weights/best.pt \
  --split test \
  --device 5 \
...
def visualize_one(
    ...
    #
    # Actual forward order for the simplified selector:
    #   [r,t,A]
    ...
    save_native(
        ...
        (
            "head[0] output from [r,t,A] only; "
            "|r-t|, BR/BT and D3 excluded; 1x1 Conv-BN-SiLU; "
    ...
    save_native(
        ...
        (
            ...
            "these channels are already fused from r/t/A and cannot be "
            "assigned back to individual sources; |r-t|, BR/BT and D3 are not inputs"
        ),
    )
    ...
    metadata = {
        ...
        "export_policy": {
            ...
            "selector_policy": "Z3/M3 uses only r,t,targetness; |r-t|, BR/BT and D3 excluded; D3 retained only in D_use=M3*D3",
            "bhlr_selector_order": [
                "33_bhlr_guidance_targetness",
                "34_rlsfa_rgb_structure_reference",
                "35_rlsfa_tir_structure_reference",
        ...
        "bhlr_v2": {
            ...
            "selector_decision": {
                "inputs": ["r", "t", "targetness"],
                "abs_r_minus_t_in_z3_decision": False,
                "rlsfa_rgb_structure_in_z3_decision": False,
                "rlsfa_tir_structure_in_z3_decision": False,
                "d3_in_z3_decision": False,
                "input_channels_when_guide_channels_24": 49,
                "detail_usage": "D3 is used only as content in D_use = M3 * D3",
                "structure_usage": "BR/BT remain RLSFA/reference features but are not Z3/M3 selector inputs",
            },
            "senet": {
                "position": "after selector head[0] 1x1 Conv-BN-SiLU, before head[1] DWConv3x3",
                "input_feature": "24-channel fused selector feature from [r,t,targetness] only",
